...
public class bot {
    ...
    public void decide() {
        System.out.println("pick preset: (v, rl, mc)");
        String preset = scanner.nextLine();

        switch(preset) {
            case "v": System.out.println("loading preset " + preset);
                new presets.valorant();
                break;
            case "rl": System.out.println("loading preset " + preset);
                new presets.rocketLeague();
                break;
            case "mc": System.out.println("loading preset " + preset);
